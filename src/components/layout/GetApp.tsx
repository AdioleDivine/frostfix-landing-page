      ...
      >
        ...
        <Box color="white" textAlign={["center", "center", "left"]}>
          ...
          <Text fontSize={["sm", "md", "lg"]} mb={6}>
            Get our mobile app on any device you use on the App Store or Google Play store.
          </Text>

          {/* Buttons for app stores */}
          <Flex justifyContent={["center", "center", "flex-start"]} gap={4}>
            {/* Google Play Button */}
            <Button
              as="a"
              href="#"
              ...
              padding={"2rem"}
            >
              <Grid templateColumns="50px auto" alignItems="center" gap={2}>
                {/* Icon on the left */}
                <Image
